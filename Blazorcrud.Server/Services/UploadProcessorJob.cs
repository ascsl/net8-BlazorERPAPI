...
public class UploadProcessorJob : IJob
{
    ...
    {
        Console.WriteLine("Server.Services.UploadProcesorJob, Execute:");
    ...
    {
        Console.WriteLine("Server.Services.UploadProcesorJob, GetUnprocessedUploads:");
    ...
    {
        Console.WriteLine("Server.Services.UploadProcesorJob, ProcessFiles:");
